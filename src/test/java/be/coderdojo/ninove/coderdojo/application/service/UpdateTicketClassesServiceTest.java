...
class UpdateTicketClassesServiceTest {
    ...
    void setParticipants_shouldUpdateMatchingTicketClasses() {
        ...
        // When
        List<TicketClass> result = updateTicketClassesService.setParticipants(eventDate, capacities, false);
        ...
        verify(eventbritePort, times(4)).updateTicketClass(eq(event.getId()), anyString(), anyInt(), anyInt());
    }
    ...
    void setParticipants_debugMode_shouldNotCallUpdatePort() {
        ...
        // When
        List<TicketClass> result = updateTicketClassesService.setParticipants(eventDate, capacities, true);
